<template>
  <v-navigation-drawer color="primary" rail="rail">
    <v-list nav>
      <v-list-item
      ...
      <v-list-item prepend-icon="mdi-wallet-bifold" to="/budgets"></v-list-item>
      ...
      <v-list-item prepend-icon="mdi-finance"></v-list-item>
